<div class="schedules index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('start_sched');?></th>
			<th><?php echo $this->Paginator->sort('end_sched');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $schedule['Schedule']['start_sched']; ?>&nbsp;</td>
		<td><?php echo $schedule['Schedule']['end_sched']; ?>&nbsp;</td>
		<td><?php echo $schedule['Schedule']['created']; ?>&nbsp;</td>
		<td><?php echo $schedule['Schedule']['modified']; ?>&nbsp;</td>
		<td class="actions">
