...
<?php echo $this->Form->create('EvaluationResult');?>
	<fieldset>
		<legend><?php __('Edit Evaluation Result'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('EvaluationResult.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('EvaluationResult.id'))); ?></li>
